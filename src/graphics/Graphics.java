...
//            }else {
//                int numRows = spriteSheet.getHeight() >> CONFIG.TILE_HEIGHT_BYTE;
//                sprites = new Sprite[numRows][];
//                for (int i = 0; i < spriteSheet.getHeight() >> CONFIG.TILE_HEIGHT_BYTE; i++) {
...
//                            pix[x + y * tileHeight] = pixels[x + (j * CONFIG.TILE_WIDTH) + y * CONFIG.TILE_WIDTH];
//                        }
//                    }
