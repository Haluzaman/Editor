...
//            delta /= 2;
            ...
            this.currentVelX += CONFIG.FRICTION*delta;
            this.velY += CONFIG.GRAVITY*delta;
...
//     }
    ...
    protected void collisionOccurs(double nextX,double nextY){
        ...
        int leftTileIndex = entityLeft >>CONFIG.TILE_WIDTH_BYTE;
        int rightTileIndex = entityRight >> CONFIG.TILE_WIDTH_BYTE;
        int downTileIndex = entityDown >> CONFIG.TILE_HEIGHT_BYTE;
        int topTileIndex = entityTop >> CONFIG.TILE_HEIGHT_BYTE;
