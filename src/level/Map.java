    ...
    private void loadTiles(){
        ...
        for(int y = 0; y < LEVEL_HEIGHT;y++){
            for(int x = 0; x < LEVEL_WIDTH;x++){
                tiles[x+y*LEVEL_WIDTH] = new Tile(Tile.WATER_TILE,x* CONFIG.TILE_WIDTH,y*CONFIG.TILE_HEIGHT);
//                if((x&1) == 0){
//                    tiles[x+y*LEVEL_WIDTH] = new Tile(Tile.GRASS_TILE,x* CONFIG.TILE_WIDTH,y*CONFIG.TILE_HEIGHT);
//                }else{
//                    tiles[x+y*LEVEL_WIDTH] = new Tile(Tile.GRASS_TILE_2,x* CONFIG.TILE_WIDTH,y*CONFIG.TILE_HEIGHT);
//                }
            }
        }
        return;
    ...
    private void loadLevel(String path){
        try{
            ...
            for(int y = 0; y < LEVEL_HEIGHT;y++){
                ...
                for(int x = 0; x < LEVEL_WIDTH;x++){
                    if(chars[x].equals("0")){
                        tiles[x+y*LEVEL_WIDTH] = new Tile(Tile.SWAMP_TILE,x* CONFIG.TILE_WIDTH,y*CONFIG.TILE_HEIGHT);
                    }else if(chars[x].equals("1")){
                        tiles[x+y*LEVEL_WIDTH] = new Tile(Tile.SWAMP_TILE,x* CONFIG.TILE_WIDTH,y*CONFIG.TILE_HEIGHT);
                    }else if(chars[x].equals("2")){
                        tiles[x+y*LEVEL_WIDTH] = new Tile(Tile.COAST_TILE,x* CONFIG.TILE_WIDTH,y*CONFIG.TILE_HEIGHT);
                    }else if(chars[x].equals("3")){
                        tiles[x+y*LEVEL_WIDTH] = new Tile(Tile.TREE_TILE,x* CONFIG.TILE_WIDTH,y*CONFIG.TILE_HEIGHT);
                    }else if(chars[x].equals("4")){
                        tiles[x+y*LEVEL_WIDTH] = new Tile(Tile.WATER_TILE,x* CONFIG.TILE_WIDTH,y*CONFIG.TILE_HEIGHT);
                    }else if(chars[x].equals("5")){
                        tiles[x+y*LEVEL_WIDTH] = new Tile(Tile.CUT_TREE_TILE,x* CONFIG.TILE_WIDTH,y*CONFIG.TILE_HEIGHT);
